...
//
//     final patientDataResponse = patientDataResponseFromJson(jsonString);

import 'dart:convert';

PatientDataResponse patientDataResponseFromJson(String str) => PatientDataResponse.fromJson(json.decode(str));

String patientDataResponseToJson(PatientDataResponse data) => json.encode(data.toJson());
...
class PatientDataResponse {
  ...
  factory PatientDataResponse.fromJson(Map<String, dynamic> json) => PatientDataResponse(

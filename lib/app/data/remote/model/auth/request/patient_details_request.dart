...
PatientDetailsRequest userDetailsRequestFromJson(String str) =>
    PatientDetailsRequest.fromJson(json.decode(str));

String userDetailsRequestToJson(PatientDetailsRequest data) =>
...
class PatientDetailsRequest {
  ...
  factory PatientDetailsRequest.fromJson(Map<String, dynamic> json) =>
      PatientDetailsRequest(
        email: json["email"],
...
class UpdatedFields {
  ...
  factory UpdatedFields.fromJson(Map<String, dynamic> json) => UpdatedFields(
        ...
        travelDetails: json["travelDetails"] == null
            ? null
            : TravelDetails.fromJson(json["travelDetails"]),
        ...
        lifestyleFactors: json["lifestyleFactors"] == null
            ? null
            : LifestyleFactors.fromJson(json["lifestyleFactors"]),
        uploadDocuments: json["uploadDocuments"] == null
            ? []
            : List<UploadDocument>.from(json["uploadDocuments"]!
                .map((x) => UploadDocument.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "uploadDocuments": uploadDocuments == null
            ? []
            : List<dynamic>.from(uploadDocuments!.map((x) => x.toJson())),
      };
}
...
class MedicalHistory {
  ...
  factory MedicalHistory.fromJson(Map<String, dynamic> json) => MedicalHistory(
        ...
        sicknessHistory: json["sicknessHistory"] == null
            ? []
            : List<String>.from(json["sicknessHistory"]!.map((x) => x)),
        surgicalHistory: json["surgicalHistory"] == null
            ? []
            : List<String>.from(json["surgicalHistory"]!.map((x) => x)),
        allergy: json["allergy"] == null
            ? []
            : List<String>.from(json["allergy"]!.map((x) => x)),
        medication: json["medication"],
        medicationTypes: json["medicationTypes"] == null
            ? []
            : List<String>.from(json["medicationTypes"]!.map((x) => x)),
        customInputMedications: json["customInputMedications"] == null
            ? []
            : List<dynamic>.from(json["customInputMedications"]!.map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "sicknessHistory": sicknessHistory == null
            ? []
            : List<dynamic>.from(sicknessHistory!.map((x) => x)),
        "surgicalHistory": surgicalHistory == null
            ? []
            : List<dynamic>.from(surgicalHistory!.map((x) => x)),
        "allergy":
            allergy == null ? [] : List<dynamic>.from(allergy!.map((x) => x)),
        "medication": medication,
        "medicationTypes": medicationTypes == null
            ? []
            : List<dynamic>.from(medicationTypes!.map((x) => x)),
        "customInputMedications": customInputMedications == null
            ? []
            : List<dynamic>.from(customInputMedications!.map((x) => x)),
      };
}
...
class VaccineHistory {
  ...
  factory VaccineHistory.fromJson(Map<String, dynamic> json) => VaccineHistory(
        immunizationHistory: json["immunizationHistory"] == null
            ? []
            : List<ImmunizationHistory>.from(json["immunizationHistory"]!
                .map((x) => ImmunizationHistory.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "immunizationHistory": immunizationHistory == null
            ? []
            : List<dynamic>.from(immunizationHistory!.map((x) => x.toJson())),
      };
}
...
class ImmunizationHistory {
  ...
  factory ImmunizationHistory.fromJson(Map<String, dynamic> json) =>
      ImmunizationHistory(
        ...
        dateOfVaccine: json["dateOfVaccine"] == null
            ? null
            : DateTime.parse(json["dateOfVaccine"]),
  ...
  Map<String, dynamic> toJson() => {
        "vaccines": vaccines,
        "dateOfVaccine":
            "${dateOfVaccine!.year.toString().padLeft(4, '0')}-${dateOfVaccine!.month.toString().padLeft(2, '0')}-${dateOfVaccine!.day.toString().padLeft(2, '0')}",

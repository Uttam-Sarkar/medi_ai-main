...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        requestDetails: json["requestDetails"] == null
            ? []
            : List<RequestDetail>.from(
                json["requestDetails"]!.map((x) => RequestDetail.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "requestDetails": requestDetails == null
            ? []
            : List<dynamic>.from(requestDetails!.map((x) => x.toJson())),
      };
}
...
class MedicalHistory {
  ...
  factory MedicalHistory.fromJson(Map<String, dynamic> json) => MedicalHistory(
        ...
        medicationTypes: json["medicationTypes"] == null
            ? []
            : List<dynamic>.from(json["medicationTypes"]!.map((x) => x)),
